...
from module1 import method_name
from module1 import method_name as mthd

every module is imported once;if you change a module reload interpreter this way:
...
#make a local name for the module
greeting = say_hello.say_hello
greeting()
...
'''
variable __name__ is equal to __main__ in the first running python file and for
called modules it is equal to the name of that module
'''
